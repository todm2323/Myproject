    ...
    <div class="col-md-6">
		...
		<div class="row">
			<div class="col-md-12">
			  <div class="row">
				<div class="col-md-3">
				<a href="pyscustomer.php"><img class="img-responsive" src="images/home.png" height="100%" > </a>
				</div>
				<div class="col-md-3">
				<a href="pysproduct.php"><img class="img-responsive" src="images/pintro.png" height="100%" > </a>
				</div>	
				<div class="col-md-3">
				<a href="askprice.php"><img class="img-responsive" src="images/list.png" height="100%" > </a>
				</div>
				<div class="col-md-3">
				<a href="me.html"><img class="img-responsive" src="images/me.png" height="100%" > </a>
				</div>
			  </div>
			</div>
		</div>
...
<div class="col-md-12"><img class="img-responsive" alt="Brand" src="http://www.toyota-forklift.com.tw/images/temp_a/banner_2.jpg"></div>
	...
	<center><button type="button" class="btn btn-link" onclick="location.href='productshow.php?brand=TOYOTA'">TOYOTA</button>  <br/>
	<center><button type="button" class="btn btn-link" onclick="location.href='productshow.php?brand=KOMATSU'">KOMATSU</button> <br/>
	<center><button type="button" class="btn btn-link" onclick="location.href='productshow.php?brand=NYK'">NYK</button> <br/>
	<center><button type="button" class="btn btn-link" onclick="location.href='productshow.php?brand=NISSION'">NISSION</button><br/>
    <center><button type="button" class="btn btn-link" onclick="location.href='productshow.php?brand=TOYOTA'">零件</button>	<br/>
...
<td><?php echo $rs["number"]?></td>
           ...
           <option value="購買">購買</option>
             ...
             <textarea  class="form-control" id="eg" name="eg" placeholder="e.g.用途"></textarea>
              </div>
             <div data-role="fieldcontain">
