<?php
  ...
  else
  {
    ...
    $sql = "SELECT * FROM tbl_user Where id = $id2";
...
<div class="col-md-12"><img class="img-responsive" alt="Brand" src="http://www.toyota-forklift.com.tw/images/temp_a/banner_2.jpg"></div>
    ...
    <div class="container">
      <form action="admin-update.php" method="post"  name="myForm">
	...
	<button type="button" class="btn btn-primary" onclick="location.href='management.php'">返回</button> 
          </td>
        </tr>
