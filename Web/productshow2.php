...
$brand=$_GET["brand"];
mysql_query("SET NAMES 'UTF8'");//ԝʷutf8 ĤťǲžģؼƘӻ׃ޘ
mysql_connect("localhost","root","0000");//ܐlocalhostԳ޵root͏ҢعҋޘԂࠩŊǛŶԝʷʺҋޘ
mysql_select_db("mydatabase");//ȚήұmemberԯΓ٪φϷܴ٪φ
...
<div class="col-md-12"><img class="img-responsive" alt="Brand" src="http://www.toyota-forklift.com.tw/images/temp_a/banner_2.jpg"></div>
  ...
  <a href="modify.php"><center><img class="img-responsive" src="images/personalinformation-01.png"></center></a><br/>
  <a href="modify.php"><center><img class="img-responsive" src="images/goodsinformation-01.png"></center></a><br/>
  <a href="modify.php"><center><img class="img-responsive" src="images/fixxxx-01.png"></center></a><br/>
  <a href="modify.php"><center><img class="img-responsive" src="images/asklistttt-01.png"></center></a><br/>
  <a href="modify.php"><center><img class="img-responsive" src="images/conpanyinformation-01.png"></center></a><br/>
  <a href="modify.php"><center><img class="img-responsive" src="images/inform-01.png"></center></a><br/>
...
?>
								...
								<tr>
								    ...
								    <td width="10%" align="center" valign="center">
                                            <button type="button" class="btn btn-primary" onclick="location.href='orderproduct1.php?productid=<?php echo $rs["id"]?>'">加入詢價單</button>
                                     </td>                             
	 </tr>									
                <?php }?>                                            
        </tbody>                       
