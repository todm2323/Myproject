<?php
  ...
  else
  {
    ...
    $sql = "SELECT * FROM customer Where id = $id2";
...
<div class="col-md-12"><img class="img-responsive" alt="Brand" src="http://www.toyota-forklift.com.tw/images/temp_a/banner_2.jpg"></div>
  ...
  <body>
    <p align="center"><img src="images/qassx.png"></p>
    <div class="container">
      <form action="res-company.php" method="post"  name="myForm">
      <table class="table table-bordered" align="center" >
        ...
        <tr bgcolor="#FFFFFF"> 
         <td align="right" > <label for="inputcname" class="control-label">*廠商名稱：</label></td>
	<td><div class="col-sm-4">
        ...
        <tr bgcolor="#FFFFFF"> 
         <td align="right" > <label for="inputcid" class="control-label">*統編：</label></td>
	<td><div class="col-sm-4">
         <input type="text" class="form-control" placeholder="cid" name="cid" value="<?php echo $row{"cid"} ?>">
         </div>
         </td>
        </tr>
		 
		 <tr bgcolor="#FFFFFF"> 
         <td align="right" > <label for="inputuname" class="control-label">*聯絡人：</label></td>
	<td><div class="col-sm-4">
	...
	<td><div class="col-sm-4">
		...
		<tr bgcolor="#FFFFFF"> 
        <td align="right" > <label for="input	ephone" class="control-label">*傳真號碼：</label></td>
        <td><div class="col-sm-4">
         <input type="text" class="form-control" placeholder="ephone" name="ephone" value="<?php echo $row{"ephone"} ?>">
         </div>
         </td>
        </tr>
