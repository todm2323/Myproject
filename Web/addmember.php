...
ini_set("smtp_port","25");
  ...
  if($username==""||$password==""||$uname==""||$cname==""||$phone==""||$cellphone==""||$address==""||$email==""){
...
h5 { font-family:Microsoft JhengHei; }
  ...
  <body bgcolor="#FFFFFF">
    <p align="center"><img src="images/qwaa.png">       
    <p align="center">恭喜您已經註冊成功了，您的帳戶資料和啟用碼已寄到您的信箱<br> 
  <button type="button" class="btn btn-primary" onclick="location.href='management.php'">回到會員管理</button>
    </p>
  </body>
</html>