...
<div class="col-md-12"><img class="img-responsive" alt="Brand" src="http://www.toyota-forklift.com.tw/images/temp_a/banner_2.jpg"></div>
    ...
    <button type="button" class="btn btn-link" onclick="location.href='productshow1.php?brand=TOYOTA'">零件</button>	<br/>
			    </div>
			</div>
...
?>
    ...
    <img src="<?php echo $rs["picture"]?>"  width="200" height="200"/></td>                                    
    ...
    <p>狀態:<?php echo $rs["state"]?></p></td>  
	<td width="10%" align="center" valign="center">
	
    <button type="button" class="btn btn-primary" onclick="location.href='join1.html?productid=<?php echo $rs["id"]?>'">請先加入會員</button>
                                     </td>                             
	 </tr>									
                <?php }?>                                            
        </tbody>                       
